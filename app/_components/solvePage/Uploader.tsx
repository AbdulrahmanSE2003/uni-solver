...
function Uploader() {
  const { file, setFile, handleSolve, setSolution, loading, solution } =
    useSolve();
  ...
  return (
    <section className="bg-white dark:bg-brand-bg rounded-3xl shadow-xl shadow-slate-200 dark:shadow-blue-800/10 border border-zinc-300 dark:border-zinc-800 overflow-hidden">
      <div className="p-8 md:p-12">
        {!file ? (
          <label className="group relative flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-zinc-300 dark:border-zinc-800 rounded-2xl cursor-pointer hover:border-blue-500 dark:hover:border-blue-500 transition-all duration-300">
