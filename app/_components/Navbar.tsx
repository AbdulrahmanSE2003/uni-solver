    ...
    return (
        ...
        >
            ...
            <div className='flex justify-center items-center gap-2'>
                ...
                <span className='font-bold text-sm tracking-tight text-brand-text'>UniSolver</span>
            </div>
                ...
                {links.map((link, i) => {
                    ...
                    return (
                        <li key={i}>
                            <Link
                                href={link.to}
                                className={`relative px-4 py-1.5 rounded-full text-sm capitalize transition-all duration-300 ${isActive
