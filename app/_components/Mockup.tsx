...
function Mockup() {
    return (
        <section className="p-5 py-20 max-w-5xl mx-auto">
            <div className="group relative bg-white/80 backdrop-blur-sm rounded-[2.5rem] w-full shadow-2xl shadow-brand-blue/15 p-8 border border-white">
                ...
                <div className="code-analysis space-y-6">
                    <div className="code-header flex gap-6 items-center">
                        ...
                        {/* Skeleton Header */}
                        <div className="w-48 h-4 bg-zinc-200 rounded-full"></div>
                    </div>
                    ...
                    <div className="code-body space-y-5">
                        ...
                        <div className="space-y-3">
                            <div className="w-3/4 animate-pulse h-4 bg-zinc-200 rounded-full" style={{ animationDelay: '0.1s' }}></div>
                            <div className="w-1/3 animate-pulse h-4 bg-zinc-200 rounded-full" style={{ animationDelay: '0.2s' }}></div>
                            <div className="w-4/6 animate-pulse h-4 bg-zinc-200 rounded-full" style={{ animationDelay: '0.3s' }}></div>
                            <div className="w-8/9 animate-pulse h-4 bg-zinc-200 rounded-full" style={{ animationDelay: '0.4s' }}></div>
                        </div>
                        ...
                        <div className="relative overflow-hidden border-2 border-dashed border-brand-blue/20 rounded-4xl p-16 w-full flex flex-col justify-center items-center bg-linear-to-b from-brand-blue/5 to-transparent">
                            ...
                            <div className="relative flex flex-col items-center gap-3">
                                ...
                                <p className="text-[10px] text-brand-blue/60 font-medium animate-pulse">Scanning PDF for questions</p>
                            </div>
                        </div>
